var perguntas = [['Em que ano começou a Revolução Francesa?', '1769', '1789', '1790', '1780', 1],
    ...
    function contar() {
        ...
        if (tempo == 0) {
            ...
            if (document.title == 'Quiz - 1 jogador') {
                ...
                console.log(nome + idade + perguntasTotal + acertos + erros)
                let player = {
                    "nome": nome,
                    "idade": idade,
                    "perguntas": perguntasTotal,
                    "acertos": acertos
                }
